...
public class SkillController {
    ...
    @GetMapping
    public R<PageResult<Skill>> list(
        ...
        return R.success(skillService.listByUser(userId, pageNum, pageSize, keyword));
    }

    @Operation(summary = "创建技能")
    @PostMapping
    public R<Skill> create(@Valid @RequestBody SkillRequest request) {
        Long userId = StpUtil.getLoginIdAsLong();
        return R.success(skillService.create(userId, request));
    }

    @Operation(summary = "修改技能")
    @PutMapping("/{id}")
    public R<Skill> update(@PathVariable Long id,
                           @Valid @RequestBody SkillRequest request) {
        Long userId = StpUtil.getLoginIdAsLong();
        return R.success(skillService.update(id, userId, request));
    }
    ...
    public R<String> export(@PathVariable Long id) {
        Long userId = StpUtil.getLoginIdAsLong();
        return R.success(skillService.exportMarkdown(id, userId));
    }
    ...
    public R<Map<String, String>> test(@PathVariable Long id,
        ...
        Long userId = StpUtil.getLoginIdAsLong();
        return R.success(skillService.test(id, userId, args));
    }
}
