...
public class KnowledgeDocumentController {
    ...
    public R<PageResult<KnowledgeDocument>> list(
        ...
        return R.success(documentService.listByKnowledgeId(knowledgeId, userId, pageNum, pageSize, keyword));
    }

    @Operation(summary = "上传文档")
    @PostMapping
    public R<KnowledgeDocument> upload(@PathVariable Long knowledgeId,
    ...
    public R<String> preview(@PathVariable Long knowledgeId,
                             @PathVariable Long docId) {
        Long userId = StpUtil.getLoginIdAsLong();
        return R.success(documentService.preview(knowledgeId, docId, userId));
    }
}
